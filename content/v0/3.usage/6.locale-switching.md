...
- [`i18n_get_locales_code()`](/v0/api-reference/functions#i18n_get_locales_code) to get all available locale codes.
- [`i18n_get_locale()`](/v0/api-reference/functions#i18n_get_locale) to get the current locale code.
- [`i18n_set_locale()`](/v0/api-reference/functions#i18n_set_locale) to change the locale.
