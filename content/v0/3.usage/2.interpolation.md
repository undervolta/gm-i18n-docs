...
You can customize the placeholder format in the `i18n_create()` function. So that you can change the opening and closing character, such as `<<key1>>` or `::key1::`. See the [API Reference](/v0/api-reference/functions#i18n_create) for more information.
::
