...
We won't discuss about static assets. Because it's really simple and you don't need to use **GM-I18n** for it. Just need to pass the asset ID to the function that need it. 
...
> Any `Asset` you passed to the `locale_asset` parameter in **current locale**.
