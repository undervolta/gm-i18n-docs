...
You can get a dynamic interpolation by updating the `plural_value` in the message reference using [`i18n_update_plurals()`](/v0/api-reference/functions/i18n-update-plurals) function.
::
