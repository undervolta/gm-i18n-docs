...
::alert{type="info"}
Currently, the [`i18n_draw_message()`](/v1/api-reference/functions/i18n-draw-message) function is the only way to directly draw the translated text in GM-I18n.
::

::alert{type="warning"}
Though it's really convenient, you shouldn't use this function too often. It's not efficient if you use it in every frame. <br> <br>
